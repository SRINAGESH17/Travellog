...
class GoaTicketOutputScreen extends StatefulWidget {
  const GoaTicketOutputScreen({super.key});

  @override
  State<GoaTicketOutputScreen> createState() => _GoaTicketOutputScreenState();
}

class _GoaTicketOutputScreenState extends State<GoaTicketOutputScreen> {
