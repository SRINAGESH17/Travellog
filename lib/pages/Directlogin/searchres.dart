...
class seearchres extends StatefulWidget {
  const seearchres({super.key});

  @override
  State<seearchres> createState() => _seearchresState();
}

class _seearchresState extends State<seearchres> {
  @override
  void initState() {
